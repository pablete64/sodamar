                    ...
                    {sectors.map((sector, i) => (
                        ...
                        >
                            <div className="flex flex-col gap-6 p-10 border border-border/40 bg-secondary/20 hover:bg-secondary/40 hover:border-primary/30 transition-all duration-500 h-full relative overflow-hidden bracket-box">
                                {/* Corner brackets */}
                                <img src="/sodamar/angle-vector.svg" alt="" className="select-button-vector is-top-left" />
                                <img src="/sodamar/angle-vector.svg" alt="" className="select-button-vector is-top-right" />
                                <img src="/sodamar/angle-vector.svg" alt="" className="select-button-vector is-bottom-left" />
                                <img src="/sodamar/angle-vector.svg" alt="" className="select-button-vector is-bottom-right" />
